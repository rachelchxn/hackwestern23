    ...
    <div className="modal" style={{ right: "-100%" }}>
      <div className="modal-content">
        ...
        <div className="modal-box">
          ...
          ></input>
          <p>
            Last updated:&nbsp;<p id="modal-card-update">test</p>{" "}
          </p>
          <p>
            Card ID:&nbsp;<p id="modal-card-id">test</p>
          </p>
          <p>
            Interactions:&nbsp;<p id="modal-card-interaction">3test</p>
          </p>
        </div>
...
const submit_modal_changes = async () => {
  ...
  const modal_card_id = document.getElementById("modal-card-id");
  const modal_card_interaction = document.getElementById(
    "modal-card-interaction"
  );
...
function App() {
  ...
  return (
    <div className="App">
      ...
      >
        <h1 style={{ marginBottom: "20px" }}>infu</h1>
        ...
        <div className="search-response">
          <p>
            Search Results: Showing&nbsp;<p id="search-card-amount">0</p>
            &nbsp;of&nbsp;<p id="search-card-total">0</p>&nbsp;results
          </p>
